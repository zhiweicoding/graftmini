...
import {auth, login} from "@graft/services/wx-service";
import {getVideoInfo} from "@graft/services/video-service";
...
const Index: React.FunctionComponent<IIndexProps> = () => {
  ...
  const start = () => {
    ...
    getVideoInfo(urlNoText).then((res) => {
      ...
      // @ts-ignore
      let path = `${Taro.env.USER_DATA_PATH}/${md5(res.url)}.mp4`;
  ...
  return (
    <View className='index padding-40'>
      ...
      <View className='bottom-bar'>
        <View className='bottom-bar-item'>
          ...
          <View className='bottom-bar-text'>
            <View className='bottom-bar-text-title'>分享给好友</View>
            <View className='bottom-bar-text-subTitle'>推荐给好友</View>
          </View>
        </View>
        <View className='bottom-bar-item'>
          <View className='bottom-bar-icon-wrapper'>
          ...
          <View>
            <View className='bottom-bar-text-title'>使用教程</View>
            <View className='bottom-bar-text-subTitle'>如何去水印</View>
          </View>
        </View>
      </View>
    </View>
